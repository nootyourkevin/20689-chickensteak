#!/usr/bin/env python3
"""端侧AI语言学习机 — Line C v2 入口（DeepSeek V4 Flash 版本）。

使用 DeepSeek V4 Flash 模型，响应更快。

启动方式：
    python src/main_deepseek_v4_flash.py --voice --asr sensevoice --llm cloud --tts piper
...
def main():
    parser = argparse.ArgumentParser(description="端侧AI语言学习机 - Line C v2 (DeepSeek V4 Flash)")
    parser.add_argument(
    ...
    # ── 创建 LLM ──
    llm = create_llm(args.llm, model="deepseek-v4-flash")
